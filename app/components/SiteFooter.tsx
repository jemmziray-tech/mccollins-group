            ...
            <ul className="space-y-5 text-gray-400">
              ...
              <li className="flex flex-col space-y-4 pt-1">
                ...
                <a href={`https://wa.me/${WHATSAPP_SALES}`} target="_blank" rel="noopener noreferrer" className="flex items-center group cursor-pointer">
                  ...
                  <div className="flex flex-col">
                    <span className="text-sm font-medium text-gray-300 group-hover:text-[#25D366] transition-colors">Sales & Orders</span>
                    <span className="text-xs text-gray-500">+{WHATSAPP_SALES}</span>
                  </div>
                </a>
                ...
                <a href={`https://wa.me/${WHATSAPP_SUPPORT}`} target="_blank" rel="noopener noreferrer" className="flex items-center group cursor-pointer">
                  ...
                  <div className="flex flex-col">
                    <span className="text-sm font-medium text-gray-300 group-hover:text-[#25D366] transition-colors">Customer Support</span>
                    <span className="text-xs text-gray-500">+{WHATSAPP_SUPPORT}</span>
                  </div>
                </a>
              </li>
